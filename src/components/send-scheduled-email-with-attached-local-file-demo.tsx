...
import { sendScheduledEmailWithAttachedLocalFile } from "@/server/actions/email";

export function SendScheduledEmailwithAttachedLocalFileDemo() {
  ...
  return (
    <div className="space-y-4">
      ...
      <button
        onClick={async () => {
          await sendScheduledEmailWithAttachedLocalFile({
            to,
            username,
          });
        }}

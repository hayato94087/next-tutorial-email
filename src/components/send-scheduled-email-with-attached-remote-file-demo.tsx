...
import { sendScheduledEmailWithAttachedRemoteFile } from "@/server/actions/email";

export function SendScheduledEmailwithAttachedRemoteFileDemo() {
  ...
  return (
    <div className="space-y-4">
      ...
      <button
        onClick={async () => {
          await sendScheduledEmailWithAttachedRemoteFile({
            to,
            username,
          });
        }}
